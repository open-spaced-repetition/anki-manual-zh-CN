...
片无帮助。请参见下面的[提前复习](#reviewing-ahead)章节了解更多信息。
...
过滤牌组无法收录暂停的、掩埋的或已经在其他过滤牌组中的卡片。如果你在使用 v1 调度器，学习中的卡片也不
...
「卡片选择依据」选项控制卡片将出现的顺序。如果你选择的最大卡片数量低于符合过滤条件的卡片数量，Anki
将首先排除这个排序列表末尾的卡片。
...
请参阅[学习](studying.md#learningrelearning-cards)章节，了解步骤如何运作。
